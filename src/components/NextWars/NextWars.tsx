...
export const NextWars: FC = () => {
  const nextWarsProps = {
    title: 'Next Wars',
    text: `Next Wars was built with Next.js, React, TypeScript, and Tailwind CSS to retrieve data from the Star Wars API. Multiple endpoints are provided to fetch a list of people and planets. The application can sort JSON data.`,
