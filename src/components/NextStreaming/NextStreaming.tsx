...
export const NextStreaming: FC = () => {
  const nextStreamingProps = {
    ...
    text: `Next Streaming is a Next.js and TypeScript microservices application that works with MongoDB to acquire video metadata. It then sends a direct message to the video storage microservice to retrieve the video from Azure Storage and stream it back to the client.`,
