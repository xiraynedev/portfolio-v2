...
export const CodingChallenge: FC = () => {
  const codingChallengeProps = {
    ...
    text: `
        This application was a coding challenge issued by another company. The requirements were to use vanilla JavaScript to fetch data from the {JSON} Placeholder API and add the data to HTML tables. The application has since been upgraded to Next.js, TypeScript, and MUI to add server-side rendering of the data.
   `,
