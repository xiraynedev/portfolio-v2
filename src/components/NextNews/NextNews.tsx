...
export const NextNews: FC = () => {
  const nextNewsProps = {
    title: 'Next News',
    text: `This project is a Next.js and TypeScript version of Hacker News. State management is handled using the Context API. Login functionality uses Firebase Authentication. Components are built with Material UI. Styling is handled via Tailwind CSS.`,
  ...
  return <ProjectComponent packageProps={nextNewsProps} />;
};
